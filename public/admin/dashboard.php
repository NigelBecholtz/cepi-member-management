    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .stat-card:hover {
            ...
            background: linear-gradient(135deg, #5A80B9 0%, #9FBBD4 100%);
        }
        .stat-card:active {
...
<body>
    <div class="container">
        ...
        <div class="stats">
            <a href="organisations.php" class="stat-card">
            ...
            <a href="#activity-logs" class="stat-card">
                <h3>Activity Logs</h3>
                <div class="number"><?= $totalLogs ?></div>
            </a>
        </div>
        
        <h2 id="activity-logs" style="margin-bottom: 20px;">Activity Logs</h2>
            ...
            <form method="GET">
                <div class="form-group">
                    ...
                    <select name="action_type" id="action_type">
                        ...
                        <option value="create_account" <?= $filterAction === 'create_account' ? 'selected' : '' ?>>Account Created</option>
                    </select>
                </div>
                <div class="form-group">
